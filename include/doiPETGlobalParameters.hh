...
#define numberOfCrystal_DOI 1
#define numberOfCrystal_tangential 20
#define numberOfCrystal_axial 10

//size of the crystals in the DOI (x), tangential (y) and axial (z) direction. 
#define sizeOfCrystal_DOI 20*mm
#define sizeOfCrystal_tangential 3.2*mm
#define sizeOfCrystal_axial 3.2*mm

//Inter crystal gap between crystals. 
#define crystalGap_DOI 0.0*mm
#define crystalGap_tangential 0.0*mm
#define crystalGap_axial 0.0*mm



//Define Aluminum thickness cover for the detector
#define AluminumCoverThickness 0. * mm

//Number of PET detectors per ring
#define numberOfDetector_perRing 38

//Number of rings in the PET system 
#define numberOfRings 8
